...
```powershell
dotnet run --project src/devtools/Lumyte.DevTools.Server --launch-profile http
dotnet run --project src/devtools/Lumyte.DevTools.Host
```
...
Full pipe configuration details are in `src/devtools/Lumyte.DevTools.Server/README.md`.
